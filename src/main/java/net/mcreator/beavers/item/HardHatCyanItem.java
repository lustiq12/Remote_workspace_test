...
public abstract class HardHatCyanItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("beavers:hard_hat_cyan"), armorMaterial);
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		...
		}, BeaversModItems.HARD_HAT_CYAN_HELMET.get());
	}

	public HardHatCyanItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends HardHatCyanItem {
		public Helmet() {
		...
		public ResourceLocation getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, ArmorMaterial.Layer layer, boolean innerModel) {
			return ResourceLocation.parse("beavers:textures/entities/hardhat_cyan.png");
		}
	}
}
