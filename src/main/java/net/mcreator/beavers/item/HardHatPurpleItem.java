...
public abstract class HardHatPurpleItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("beavers:hard_hat_purple"), armorMaterial);
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		...
		}, BeaversModItems.HARD_HAT_PURPLE_HELMET.get());
	}

	public HardHatPurpleItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends HardHatPurpleItem {
		public Helmet() {
		...
		public ResourceLocation getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, ArmorMaterial.Layer layer, boolean innerModel) {
			return ResourceLocation.parse("beavers:textures/entities/hardhat_purple.png");
		}
	}
}
