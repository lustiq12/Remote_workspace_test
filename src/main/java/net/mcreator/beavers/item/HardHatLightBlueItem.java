...
public abstract class HardHatLightBlueItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("beavers:hard_hat_light_blue"), armorMaterial);
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		...
		}, BeaversModItems.HARD_HAT_LIGHT_BLUE_HELMET.get());
	}

	public HardHatLightBlueItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends HardHatLightBlueItem {
		public Helmet() {
		...
		public ResourceLocation getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, ArmorMaterial.Layer layer, boolean innerModel) {
			return ResourceLocation.parse("beavers:textures/entities/hardhat_light_blue.png");
		}
	}
}
