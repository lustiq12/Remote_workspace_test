...
public abstract class HardHatGrayItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("beavers:hard_hat_gray"), armorMaterial);
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		...
		}, BeaversModItems.HARD_HAT_GRAY_HELMET.get());
	}

	public HardHatGrayItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends HardHatGrayItem {
		public Helmet() {
		...
		public ResourceLocation getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, ArmorMaterial.Layer layer, boolean innerModel) {
			return ResourceLocation.parse("beavers:textures/entities/hardhat_gray.png");
		}
	}
}
